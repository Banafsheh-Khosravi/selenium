...
public class BrokenLinks {
	public static void main(String[] args) throws InterruptedException {
		// Instantiating Chrome
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\bani.khosravinia\\Desktop\\Work\\selenium-work\\src\\main\\resources\\chromedriver.exe");
		...
		driver.get("https://staging_xvbnwi:EGS5ab8STy4B@michiganhispaniccollaborativeorg.stage.site/");
...
//			}
			 if (httpConn.getResponseCode() >= 400) {
				    ...
				    System.out.println(urlLink + " - " + "is valid Link");
				   }
		}
